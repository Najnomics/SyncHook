...
import {SyncHookL1} from "@project/l1-contracts/SyncHookL1.sol"; // Import SyncHook L1 contract
...
contract DeployMyL1Contracts is Script {
    ...
    function run(string memory environment, string memory _context) public {
        ...
        // Deploy SyncHook L1 contract
        SyncHookL1 syncHookL1 = new SyncHookL1();
        console.log("SyncHookL1 deployed to:", address(syncHookL1));
        ...
        outputs[0] = Output({name: "SyncHookL1", contractAddress: address(syncHookL1)});

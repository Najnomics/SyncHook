...
import {SyncHookL2} from "@project/l2-contracts/SyncHookL2.sol"; // Import SyncHook L2 contract
...
contract DeployMyL2Contracts is Script {
    ...
    function run(string memory environment, string memory _context) public {
        ...
        // Deploy SyncHook L2 contract
        SyncHookL2 syncHookL2 = new SyncHookL2();
        console.log("SyncHookL2 deployed to:", address(syncHookL2));
        ...
        outputs[0] = Output({name: "SyncHookL2", contractAddress: address(syncHookL2)});
